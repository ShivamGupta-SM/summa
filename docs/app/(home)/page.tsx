		...
		items: [
			{
				...
				description: "Two transfers from the same account at the same time? They queue safely. You can never spend more than what's available.",
			},
			{
				icon: FingerPrintIcon,
				title: "Safe Retries",
				description: "Network glitch? Client crash? Retry the same request and get the original result back. Duplicate charges are impossible.",
			},
			{
				icon: HandRaisedIcon,
