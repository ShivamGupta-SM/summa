...
| `PATCH` | `/accounts/:holderId/overdraft` | Update overdraft settings |
...
| `POST` | `/transactions/force-debit` | Force debit (bypasses balance checks) |
| `POST` | `/transactions/transfer` | Transfer between accounts |
| `POST` | `/transactions/force-transfer` | Force transfer (bypasses balance checks) |
