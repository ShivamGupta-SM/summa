...
| **High-traffic accounts** | Hot account pattern, mega CTE combined writes, and high-throughput transaction batching for 100,000+ TPS |
...
<Cards>
  ...
  <Card title="100,000+ TPS" href="/docs/scaling">
    Mega CTE combined writes, high-throughput transaction batching, denormalized balance cache, and lock retry with backoff. Full HMAC integrity at every throughput level.
  </Card>
</Cards>
