...
<Cards>
  ...
  <Card title="13 Built-in Plugins" href="/docs/plugins">
    Reconciliation, snapshots, velocity limits, audit log, outbox, DLQ, hot accounts, scheduled transactions, admin, OpenAPI, observability, and more.
  </Card>
...
<Cards>
  ...
  <Card title="Plugins" href="/docs/plugins">
    Extend with 13 built-in plugins.
  </Card>
