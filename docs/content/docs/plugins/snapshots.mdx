...
import { snapshots } from "@summa-ledger/summa/plugins";
...
```ts
import { getHistoricalBalance } from "@summa-ledger/summa/plugins";
...
```ts
import { getEndOfMonthBalance } from "@summa-ledger/summa/plugins";
