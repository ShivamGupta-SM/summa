...
The velocity limits plugin enforces configurable limits on transaction amounts, protecting against fraud, abuse, and regulatory non-compliance. Limits can be set per-transaction, daily, or monthly — with optional **category-based segmentation**.
