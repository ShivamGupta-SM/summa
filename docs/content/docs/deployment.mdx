...
By default, Summa creates all tables in the `"@summa-ledger/summa"` PostgreSQL schema, keeping them isolated from your application's `public` schema. You can verify this after migration:
